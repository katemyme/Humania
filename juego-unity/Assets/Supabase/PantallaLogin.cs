...
{
    [Header("Arrastra aqu� tus campos de la pantalla Entrar")]
    ...
    void OnEnable()
    {
        // Los 3 campos llaman a la misma revisi�n. No importa en cu�l de
    ...
    void IntentarEntrar()
    {
        ...
        {
            Debug.LogWarning("Completa usuario, contrase�a y c�digo.");
            return;
        }
    ...
    IEnumerator EntrarFlujo()
    {
        ...
        using (UnityWebRequest req = new UnityWebRequest(url, "POST"))
        {
            ...
            {
                Debug.LogError("Usuario o contrase�a incorrectos.");
                enviando = false;
                yield break;
            }
        ...
        // 2) Unirse a la sala con el c�digo
        ...
        using (UnityWebRequest req = new UnityWebRequest(urlSala, "POST"))
        {
            ...
            if (req.result != UnityWebRequest.Result.Success)
            {
                Debug.LogError("C�digo de sala inv�lido o inactivo.");
                enviando = false;
                yield break;
            }
        ...
        // Aqu� despu�s cargamos la siguiente escena (el hub del juego)
